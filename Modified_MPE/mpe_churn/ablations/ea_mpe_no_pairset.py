"""
Ablation: EA without Pair-Set Critic on MPE.
...
class MPE_EA_NoPairSet(MPE_EA):
    """EA without Pair-Set Critic. Reuses MPE_EA but with EAAgentNoPairSet."""

    def __init__(self, device: str = "cpu"):
        # Skip MPE_EA.__init__, call grandparent
        ...
        for i, ctrl_id in enumerate(self.ctrl_ids):
            self.agents[ctrl_id] = EAAgentNoPairSet(
