"""
MATD3 Baseline Test: 4 Managers Environment with Low Severity, Mid Frequency Churn

This test validates MATD3's performance under device churn using compatibility layer.
