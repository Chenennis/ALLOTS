"""
AGILE Baseline Test: 10 Managers Environment with Low Severity, Mid Frequency Churn
...
- Churn Severity: Low (10-15% devices change)
...
CHURN_SEVERITY_LEVELS = [0.10, 0.125, 0.15]
