"""
EA Ablation Test: 10Manager + High Churn + w/o Per-Device Credit
=============================================================

Ablation variant: Uniform weights (NO Per-Device Credit)
- All devices contribute equally to actor loss
- Tests if per-device credit assignment accelerates adaptation

Environment: 10 Managers
Churn Severity: High (10-14% devices change)
...
# ============== Ablation Info ==============
ABLATION_TYPE = "no_credit"
ABLATION_NAME = "w/o Per-Device Credit"
...
CHURN_SEVERITY_LEVELS = [0.1, 0.12, 0.14]
...
def create_agent(num_managers: int):
    """Create ABLATION Agent: w/o Per-Device Credit"""
    agent = EAAgentNoCredit(
        x_dim=X_DIM,
        g_dim=G_DIM,
        p=P,
        N_max=N_MAX,
