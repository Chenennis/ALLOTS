"""
EA Algorithm Test: 10Manager Environment with Mid Severity, MIDF Churn

This test validates EA's learning capability under moderate device churn:
- Environment: 10 Managers
- Churn Severity: Mid (4.0%-6.0% devices change)
...
# ============== Churn Parameters ==============
CHURN_ENABLED = True
CHURN_SEVERITY = "mid"  # low/mid/high
...
NOISE_SCALE = 0.1
NOISE_CLIP = 0.2
ADVANTAGE_TAU = 2.0  # Temperature for softmax advantage weighting (lower = sharper focus)
